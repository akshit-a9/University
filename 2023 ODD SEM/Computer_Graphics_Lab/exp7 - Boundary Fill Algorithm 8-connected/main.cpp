...
void drawShape() {
    ...
    glVertex2i(100 * scale, 100 * scale);
    glVertex2i(300 * scale, 100 * scale);
    glVertex2i(300 * scale, 300 * scale);
    glVertex2i(100 * scale, 300 * scale);
    glEnd();
    ...
    boundaryFill((200 * scale),(290 * scale) , fillColor, boundaryColor);
    glutSwapBuffers();
